...
class WeatherWidgetConfigureActivity : Activity() {
    ...
    public override fun onCreate(icicle: Bundle?) {
        ...
        mAppWidgetText?.setText(loadTitlePref(this@WeatherWidgetConfigureActivity, mAppWidgetId))
    }

    companion object {

        private val PREFS_NAME = "edu.pk.weatherapp.WeatherWidget"
        ...
        internal fun loadTitlePref(context: Context, appWidgetId: Int): String {
            ...
            return titleValue ?: context.getString(R.string.default_city)
        }
